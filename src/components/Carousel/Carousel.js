  ...
  return (
    <div className={styles.carousel}>
      ...
      >
        ...
        <SwiperSlide className={styles.slide}> <img src="/img-iphones1.jpg" alt=""/> </SwiperSlide>
        <SwiperSlide className={styles.slide}> <img src="/img-iphones2.jpg" alt=""/> </SwiperSlide>
